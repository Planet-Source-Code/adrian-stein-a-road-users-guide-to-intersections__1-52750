...
Begin VB.Form Form11 
   ...
   Caption         =   "Traffic Lights Not Working Test 3"
   ClientHeight    =   6240
   ClientLeft      =   2850
   ClientTop       =   2235
   ClientWidth     =   8940
   ...
   Begin VB.Label Label5 
      Caption         =   "Any car can go as long as it moves out slowly ready to stop, if another car starts moving as well."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   2760
      Left            =   5520
      Picture         =   "Traffic Lights Not Working33.frx":0000
      Stretch         =   -1  'True
      Top             =   1080
      Width           =   3315
   End
